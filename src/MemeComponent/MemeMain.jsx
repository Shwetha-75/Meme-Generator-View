...
export default function MemeMain() {
  ...
  return (
    ...
    <MemeContainer className=" h-[100%]  p-2 ">
      <Panel weight={4} className=" h-[80%] p-5 w-[100%] flex justify-center items-center border border-slate-500">
        <EditMemeMain/>
      </Panel>
      <Panel   className="w-[2px] bg-slate-800 h-[80%]"></Panel>
      <Panel weight={1.6} className="h-[80%] w-[100%] rounded-sm">
          <ImagesComponent/>
      </Panel>
    </MemeContainer>
