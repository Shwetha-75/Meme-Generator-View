...
export default function AddTextBoxComponent({
  ...
  return (
    <Container className={`w-[96%] flex flex-col ${index>0?"mt-[7%]":"mt-[5%]"} container--each--menu--tag`}>
      ...
      <Panel className={`overflow-hidden ${textBoxDisplay?"text--box--display":"text--box--display--active"} shadow-xl`}>
